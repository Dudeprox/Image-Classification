...
if __name__ == "__main__":
    ...
    for i, row in df.iterrows():
        data.append((row[0].replace(u'\xa0', u' ').
                     replace('.', '').
                     replace(u'\n', u' ').
    ...
    # # Convert String Sell Values to Numeric
    ...
    # del df["q_quote"]
    #
    # # Each rank, ['rank_1', 'rank_2', 'rank_3', 'rank_4', 'rank_5'] in columns,
    # # is associated to a certain quote number (or index). For example,
    # # If rank 1 value is 4, then the fourth quote has rank 1 making it
    # # most relatable.
    #
